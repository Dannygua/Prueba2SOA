...
@NamedQueries({
    ...
    , @NamedQuery(name = "Peliculas.findByAnioProducto", query = "SELECT p FROM Peliculas p WHERE p.anioProducto = :anioProducto")
...
public class Peliculas implements Serializable {
    ...
    public Peliculas(Integer id, String titulo, String genero, String idioma, String duracion, String calificacion, String resumen, String anioProducto, String formato, String director, String clasificacion, String imagen) {
        this.id = id;
        this.titulo = titulo;
        this.genero = genero;
        this.idioma = idioma;
